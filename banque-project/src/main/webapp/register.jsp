...
<div class="center-layout">
    <div class="form-card animate">
        ...
        <form action="register" method="post">
            ...
            <input type="text" id="address" name="address" placeholder="123 Vinyl Street">
            <div class="two-col">
                <div>
            ...
            <input type="text" id="tel" name="tel" placeholder="+1 000 000 0000">
            <label for="password">Password</label>
            <input type="password" id="password" name="password" placeholder="••••••••">
            <button type="submit" class="btn btn-primary btn-block" style="margin-top: 28px;">Create Account</button>
        </form>
        <div class="bottom-note" style="margin-top: 24px;">
            Already have an account? <a href="auth" class="link">Sign in</a>
        </div>
    </div>
</div>
</body>
