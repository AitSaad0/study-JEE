...
<div class="center-layout">
    <div class="form-card">
        ...
        <form action="auth" method="post">
            ...
            <input type="text" id="email" name="email" placeholder="your@email.com" autocomplete="email">
            <label for="password">Password</label>
            <input type="password" id="password" name="password" placeholder="••••••••">
            <button type="submit" class="btn btn-primary btn-block" style="margin-top: 28px;">Sign In</button>
        </form>
        <div class="bottom-note" style="margin-top: 24px;">
            No account yet? <a href="register" class="link">Create one</a>
        </div>
    </div>
</div>
</body>
